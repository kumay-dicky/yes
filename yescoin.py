...
def main():
    ...
    while True:
        ...
        import sys
        waktu_tunggu = 80  # 5 menit dalam detik
        for detik in range(waktu_tunggu, 0, -1):
            sys.stdout.write(f"\r{Fore.CYAN}Menunggu waktu claim berikutnya dalam {Fore.CYAN}{Fore.WHITE}{detik // 300} menit {Fore.WHITE}{detik % 300} detik")
            sys.stdout.flush()
            time.sleep(1)
